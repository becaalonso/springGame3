package com.senai.Rebeca.Prj.controler;
...
import com.senai.Rebeca.Prj.service.JogoService;
...
public class JogoControler {
	...
	@PostMapping
	public Jogo createclient(@RequestBody Jogo jogo) {
	...
	public ResponseEntity<Jogo> getJogo(@PathVariable Long id) {
		Jogo jogo = jogoService.getidJogoById(id);
		if (jogo != null) {
